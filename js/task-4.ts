...
const input2: null | string = prompt('Введите количество дроидов которые хотите купить:');
if (input2 === null) {
  console.log('Отменено пользователем!');
} else {
  let totalPrice = pricePerDroid * Number(input2);
  ...
  if (totalPrice > credits) {
    ...
    console.log(
      `Вы купили ${Number(
        input2,
      )} дроидов, на счету осталось ${credits} кредитов.`,
    );
  }
}
